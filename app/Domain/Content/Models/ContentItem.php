...
class ContentItem extends Model
{
    ...
    protected $fillable = ['tenant_id', 'content_number', 'collaboration_id', 'campaign_id', 'deliverable_id', 'creator_id',
        ...
        'published_url', 'proof_note', 'proof_by', 'proof_at', 'publish_reminded_at',
    ...
    public function hasPublishProof(): bool
    {
        return (bool) $this->published_url;
    }
    ...
    {
        return $this->hasMany(ContentStatusHistory::class);
    }
}
