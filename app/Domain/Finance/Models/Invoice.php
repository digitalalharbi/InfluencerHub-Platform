...
class Invoice extends Model
{
    ...
    protected $fillable = [
        ...
        'issue_date', 'due_date', 'issued_at', 'paid_at', 'cancelled_at', 'notes', 'cancel_reason', 'created_by', 'overdue_notified_at',
    ];
    ...
    protected $casts = [
        ...
        'issued_at' => 'datetime', 'paid_at' => 'datetime', 'cancelled_at' => 'datetime', 'overdue_notified_at' => 'datetime',
    ];
