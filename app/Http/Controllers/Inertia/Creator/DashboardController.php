...
class DashboardController extends Controller
{
    public function index(Request $r): Response
    {
        ...
        return Inertia::render('CreatorPortal/Dashboard', [
            ...
            'pending' => [
                ['key' => 'collaborations', 'label' => trans('creator_dashboard.pending_collaborations'), 'count' => $activeCollabs, 'icon' => 'git-merge', 'link' => '/collaborations'],
                ['key' => 'content', 'label' => trans('creator_dashboard.pending_content'), 'count' => $contentTodo, 'icon' => 'image', 'link' => '/content'],
                ['key' => 'contracts', 'label' => trans('creator_dashboard.pending_contracts'), 'count' => $contractsPending, 'icon' => 'file-text', 'link' => '/contracts'],
                ['key' => 'payouts', 'label' => trans('creator_dashboard.pending_payouts'), 'count' => $payoutsOpen, 'icon' => 'wallet', 'link' => '/payouts'],
            ],
