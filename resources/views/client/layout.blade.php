...
<head>
    ...
    <title>@yield('title', 'بوابة العميل') — InfluencerHub</title>
...
<div class="ih-shell has-bottom-nav" x-data="{ nav:false }" :class="{ 'nav-open': nav }" @keydown.escape.window="nav=false"><div class="ih-scrim" @click="nav=false"></div>
    <aside class="sidebar" style="display:flex; flex-direction:column; padding:1.2rem 1rem;" @click="nav=false">
        <a href="/client/dashboard" style="display:flex; align-items:center; gap:.5rem; font-weight:800; font-size:1.05rem; color:var(--brand); text-decoration:none; padding:.4rem .5rem 1rem;" aria-label="InfluencerHub — الرئيسية"><x-ih-logo :size="22" /> <span>بوابة العميل</span></a>
        {{-- مبدّل العميل --}}
    ...
    <main style="flex:1; display:flex; flex-direction:column; min-width:0;">
        <div class="ih-topbar-mobile"><button class="ih-icon-btn" @click="nav=true" aria-label="فتح القائمة"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="6" y2="6"/><line x1="3" x2="21" y1="12" y2="12"/><line x1="3" x2="21" y1="18" y2="18"/></svg></button><a href="/client/dashboard" style="text-decoration:none; display:inline-flex;" aria-label="InfluencerHub — الرئيسية"><x-ih-logo :size="22" :withWordmark="true" color="var(--ih-primary)" /></a><span style="margin-inline-start:auto; font-weight:700; font-size:.9rem;">@yield('heading','')</span></div>
