...
<div class="ih-shell has-bottom-nav" x-data="{ nav:false }" :class="{ 'nav-open': nav }" @keydown.escape.window="nav=false">
    ...
    <aside class="sidebar ih-side" @click="nav=false">
        <a href="/app" class="ih-side__brand" aria-label="InfluencerHub — الرئيسية">
            <x-ih-logo :size="28" :withWordmark="true" color="var(--ih-primary)"/>
        </a>
    ...
    <main style="flex:1; display:flex; flex-direction:column; min-width:0;">
        <div class="ih-topbar-mobile">
            ...
            <a href="/app" style="text-decoration:none; display:inline-flex; align-items:center;" aria-label="InfluencerHub — الرئيسية"><x-ih-logo :size="24" :withWordmark="true" color="var(--ih-primary)"/></a>
