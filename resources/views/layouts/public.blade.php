...
<head>
    ...
    <title>@yield('title', 'انضمام المبدعين') — InfluencerHub</title>
...
<header style="background:var(--surface); border-bottom:1px solid var(--border); padding:1rem 1.5rem; display:flex; align-items:center; gap:1rem;">
    <a href="/join" style="font-weight:800; font-size:1.15rem; color:var(--brand); text-decoration:none;" aria-label="InfluencerHub — الرئيسية"><x-ih-logo :size="26" :withWordmark="true" color="var(--brand)"/></a>
