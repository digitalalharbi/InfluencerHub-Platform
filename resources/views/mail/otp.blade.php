<x-mail.layout title="رمز التحقق — InfluencerHub" preheader="رمز التحقق الخاص بك في InfluencerHub.">
  <div style="display:inline-block;margin:0 0 16px;padding:7px 12px;background:#f7f5ff;border:1px solid #e8e3ff;border-radius:999px;color:#5B45E0;font-size:12px;font-weight:700;">تأكيد الحساب</div>
  ...
  <p style="margin:0 0 24px;font-size:15px;line-height:1.9;color:#475467;">استخدم الرمز التالي لتأكيد بريدك وإكمال طلب الانضمام في InfluencerHub.</p>
