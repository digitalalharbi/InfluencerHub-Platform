<x-mail.layout title="تأكيد البريد — InfluencerHub" preheader="أكد بريدك الإلكتروني للمتابعة في InfluencerHub.">
  <div style="display:inline-block;margin:0 0 16px;padding:7px 12px;background:#f7f5ff;border:1px solid #e8e3ff;border-radius:999px;color:#5B45E0;font-size:12px;font-weight:700;">تفعيل البريد</div>
  ...
  <p style="margin:0 0 24px;text-align:center;">
    <a href="{{ $verifyUrl }}" style="display:inline-block;background:#5B45E0;color:#ffffff;text-decoration:none;font-weight:800;border-radius:10px;padding:14px 30px;min-width:160px;text-align:center;">تأكيد البريد</a>
  </p>
